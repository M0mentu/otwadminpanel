...
const Ecommerce = () => {
  ...
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap juftify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44  rounded-xl w-full lg:w-full p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl ">$66,550.65</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className=" dark:bg-secondary-dark-bg bg-white dark:text-gray-200 m-3 p-4 rounded-2xl md:w-780">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-gray-500 m-4 pr-10 ">
              <div>
                <p>
                  <span className="text-3xl font-semibold">$92,421</span>
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">$48,421</span>
                </p>
